                                        ...
                                        style="margin-left: 80px" enctype="multipart/form-data" >
                                                ...
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="memberId"
                                                        name="memberId" placeholder="memberId" value="">
                                                </div>
                                                <div class="col-12 mb-3">
                                                ...
                                                <div class="cart-btn col-12 mt-100 ">
                                                    <input class="btn amado-btn w-100" id="submit" type="submit"
                                                        value="confirm">
                                                </div>
            ...
            <script>
                $(function () {
                    ...
                    $("#gender").blur(function () {
                        if ($(this).val() == "default" && $(this).siblings().length < 2) {
                    ...
                    function checkAllFilled() {
                        if ($("#memberId").val() != "" && $("#name").val() != "" && $("#password").val() != "" && $("#email").val() != "" && $("#gender").val() != "default") {
                            return true;
                        } else {
                            return false;
                        }
