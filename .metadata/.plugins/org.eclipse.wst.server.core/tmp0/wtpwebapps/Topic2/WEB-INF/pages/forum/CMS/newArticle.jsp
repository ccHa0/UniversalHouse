                    ...
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <div class="cart-title" style="text-align: center;">
                            	...
                            	<form action="<c:url value='/newArticle_CMS'/>" method="post" style="margin-left: 80px;" enctype="multipart/form-data">
									...
									<div class="col-18 mb-3">						
										<label for="like">讚：</label>
										<input type="number" class="form-control" name="like" id="like" value="0" min="0">
	                                </div>
                                									
									<div class="col-18 mb-3">								
										<label for="dislike">爛：</label>
										<input type="number" class="form-control" name="dislike" id="dislike" value="0"  min="0">
	                                </div>
										
									<div class="col-18 mb-3">						 
										<label for="title">文章主題：${errorTitleDup}</label>
										<input type="text" class="form-control" name="title" id="title" value="${param.title}" required />
	                                </div>
									...
									<div class="col-18 mb-3">									
										...
										<input type="file" name="images" id="images" accept="image/gif, image/jpeg, image/png" multiple/>
	                                </div>

	                                <div class="cart-btn mt-100">
	                                    <input type="submit" class="btn amado-btn w-100" id="submit" value="送出">
	                                </div>
	                                
	                                <div class="cart-btn mt-100">   
	                                    <input type="submit" class="btn amado-btn w-100" id="submit" value="清除">
	                                </div>
