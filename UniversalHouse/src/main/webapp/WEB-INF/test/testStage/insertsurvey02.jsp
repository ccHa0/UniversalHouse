        ...
        <div class="cart-table-area ">
          <div class="container-fluid">
            <div class="cart-title mt-50">
              <h1 style="color: rgb(133, 133, 133)">新增問卷題目</h2>
            </div>
            <!-- <div class="row"> -->
            <div class="cart-title mt-50">
        ...
        $(function () {
          ...
          $(function () {
            ...
            $('#inputtext').on('click', function () {
              ...
              // }
              $('.testis.0 .examinationquestion input').val('是否喜歡平台的功能');
              $('.testis.0 .options input[name="options"]').val('是');
              $('.testis.0 .options input[name="options2"]').val('否');


              $('.testis.1 .examinationquestion input').val('平台操作是否淺顯易懂');
              $('.testis.1 .options input[name="options"]').val('是');
              $('.testis.1 .options input[name="options2"]').val('否');


              $('.testis.2 .examinationquestion input').val('對這平台的滿意程度');
              $('.testis.2 .options input[name="options"]').val('非常滿意');
              $('.testis.2 .options input[name="options2"]').val('滿意');
              $('.testis.2 .options input[name="options3"]').val('不滿意');
              $('.testis.2 .options input[name="options4"]').val('非常不滿意');
