...
<body>
	...
	<div class="main-content-wrapper d-flex clearfix">
			...
			<nav class="amado-nav">
				<ul>
					...
					<div class="catagories-menu" id="showShopSideBar1">
						<ul>
							<li><a href="/admin/insertTest"
								style="text-shadow: 0px 0px 5px #C0C0C0;">存入功能</a></li>
							<li><a href="/admin/showtester"
								style="text-shadow: 0px 0px 5px #C0C0C0;">測驗結果</a></li>
							<li><a href="/admin/showQuestionResults"
								style="text-shadow: 0px 0px 5px #C0C0C0;">問卷調查結果</a></li>
						</ul>
					</div>
		...
		<!-- Header Area End -->
		<div class="row">
			<div class="section-padding-100 col-12">
				<div class="container-fluid">
					<div>
						...
						<form action="/admin/exportCsvcon" id="form"
							enctype="multipart/form-data" method="get" style="">

							<table id="myTable" class="" style="">
							...
							<nav class="navbar navbar-expand-lg justify-content-end">
								...
								<div class="collapse navbar-collapse" id="footerNavContent">
									<ul class="navbar-nav ml-auto">
										...
										<li class="nav-item"><a class="nav-link"
											href="/admin/projects/showAllEntrusBacktage/1">專案</a></li>
										<li class="nav-item"><a class="nav-link"
